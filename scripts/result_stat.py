...
home = expanduser("~")
paths = [os.path.join(home, 'BlindKameris-new/outputs-r202/MLDSP-prediction-full-path.csv'),\
    os.path.join(home, 'BlindKameris-new/outputs-HGR-r202/HGR-prediction-full-path.csv')]
...
from os.path import expanduser
home = expanduser("~")
path1 = os.path.join(home, 'BlindKameris-new/outputs-r202/MLDSP-prediction-full-path.csv')
...
path2 = os.path.join(home, 'BlindKameris-new/outputs-HGR-r202/HGR-prediction-full-path.csv')
