...
path1 = os.path.join(config.MT_MAG_path, 'outputs-r202/MLDSP-prediction-full-path.csv')
...
path2 = os.path.join(config.MT_MAG_path, 'outputs-HGR-r202/HGR-prediction-full-path.csv')
